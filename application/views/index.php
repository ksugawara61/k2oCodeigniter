<div id="pageBody">
    <section class="mainVisual">
        <ul  class="bxslider">
            <li>
                ...
                <img src="/assets/images/portfolio/main_img_03_01.jpg" width="980" height="500" alt="">
            </li>
            <li>
                <div class="mainVisualText">
                ...
                <img src="/assets/images/portfolio/main_img_02_01.jpg" width="980" height="500" alt="">
            </li>
            <li>
                <div class="mainVisualText">
                    <h1>Cafe Debut</h1>
                ...
                <img src="/assets/images/portfolio/main_img_01_01.jpg" width="980" height="500" alt="">
            </li>
        </ul>
    </section>
    ...
    <section class="portfolioIndex">
        <article>
            <a href="portfolio/03.html"><img src="/assets/images/portfolio/img_03_01.jpg" width="300" height="163" alt=""></a>
            <h2><a href="portfolio/03.html">バッタになりたい魔法使い</a></h2>
            <p>コモモ・ひろましゃ制作のWeb仕掛け絵本<br>合い言葉は、バッタになっちゃえ！</p>
        </article>

        <article>
            <a href="portfolio/02.html"><img src="/assets/images/portfolio/img_02_01.jpg" width="300" height="163" alt=""></a>
            <h2><a href="portfolio/02.html">WordPressデザインワークブック</a></h2>
            <p>コモモとひろましゃ二人の共著によるWordPressで本格的なウェブサイトを制作したい方向けの書籍</p>
        </article>

        <article>
            <a href="portfolio/01.html"><img src="/assets/images/portfolio/img_01_01.jpg" width="300" height="163" alt=""></a>
